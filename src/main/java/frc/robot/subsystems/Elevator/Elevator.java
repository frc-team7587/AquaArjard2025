...
public class Elevator extends SubsystemBase {
  ...
  public void setPID(double setpoint) {
    if (setpoint > ElevatorConstants.kElevatorMaxHeight)
      setpoint = ElevatorConstants.kElevatorMaxHeight;
    else if (setpoint < ElevatorConstants.kElevatorMinHeight)
      setpoint = ElevatorConstants.kElevatorMinHeight;
